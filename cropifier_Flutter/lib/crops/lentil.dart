              ...
              children: [
                TableRow(
                  ...
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('Lentil', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
                TableRow(
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('The lentil(Lens culinaris or Lens esculenta) is an edible legume. It is an annual plant known for its lens-shaped seeds. It is about 40 cm (16 inch) tall, and the seeds grow in pods, usually with two seeds in each. As a food crop, the majority of world production comes from Canada and India, producing 58% combined of the world total.', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
                TableRow(
                  ...
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('6.0 and 6.5', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
                ...
                TableRow(
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('April.', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
                TableRow(
                  ...
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('Cold (temperate).', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
                TableRow(
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('About 1 inch of water.', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
                TableRow(
                  ...
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('Bihar, Uttar Pradesh and Rajasthan.', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
                TableRow(
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('Lens culinaris.', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
    ...
    return new MaterialApp(
        ...
        home: new Scaffold(
            ...
            floatingActionButton: FloatingActionButton(
              ...
              backgroundColor: Colors.green,
              onPressed: () async {
                final ByteData bytes = await rootBundle.load('assets/documents/Lentil.txt');
                await Share.file('Lentil', 'Lentil.txt', bytes.buffer.asUint8List(), 'text/plain');
              },
            ),
            body: new ListView(
              children: <Widget>[
