              ...
              children: [
                TableRow(
                  ...
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('Cotton', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
                ...
                TableRow(
                  ...
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('7.0 to 8.0', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
                ...
                TableRow(
                  ...
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('Black Soil.', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
                TableRow(
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('April to May.', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
                ...
                TableRow(
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('800 to 1000 mm.', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
                TableRow(
                  ...
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('Punjab, Haryana, Maharashtra, Tamilnadu, Madhya Pradesh and Gujarat.', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
                TableRow(
                  children: [
                    ...
                    Column(
                      children: <Widget>[
                        Text('Gossypium.', textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
                      ],
                    ),
                  ],
                ),
    ...
    return new MaterialApp(
        ...
        home: new Scaffold(
            ...
            floatingActionButton: FloatingActionButton(
              ...
              backgroundColor: Colors.green,
              onPressed: () async {
                final ByteData bytes = await rootBundle.load('assets/documents/Cotton.txt');
                await Share.file('Cotton', 'Cotton.txt', bytes.buffer.asUint8List(), 'text/plain');
              },
            ),
            body: new ListView(
              children: <Widget>[
