...
import com.example.phase_1.AlarmReceiver;
import com.example.phase_1.R;
import com.example.phase_1.adapters.ViewPagerAdapter;
import com.example.phase_1.adapters.WeatherRecyclerAdapter;
import com.example.phase_1.fragments.AmbiguousLocationDialogFragment;
import com.example.phase_1.fragments.RecyclerViewFragment;
import com.example.phase_1.models.Weather;
import com.example.phase_1.tasks.GenericRequestTask;
import com.example.phase_1.tasks.ParseResult;
import com.example.phase_1.tasks.TaskOutput;
import com.example.phase_1.utils.Formatting;
import com.example.phase_1.utils.UnitConvertor;
import com.example.phase_1.widgets.AbstractWidgetProvider;
import com.example.phase_1.widgets.DashClockWeatherExtension;
    ...
    private void updateTodayWeatherUI() {
        ...
        send_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("todayTemp_key", todayTemp);
                intent.putExtra("todayHumid_key", todayHumid);
...
//    }
    ...
    private void checkWeather(){
        ...
        if(cond.contains("thunderstorm")){
            todaydes.setText(R.string.thunderstorm);
            if(time.equals("day")){
            ...
            todaydes.setText(R.string.drizzle);
            if(time.equals("day")){
            ...
            todaydes.setText(R.string.rain1);
            if(time.equals("day")){
                todayIcon.setImageDrawable(getResources().getDrawable(R.drawable.stormday));
                ;
            }else if(time.equals("night")){
            ...
            todaydes.setText(R.string.snow);
            if(time.equals("day")){
            ...
            todaydes.setText(R.string.mist);
            if(time.equals("day")){
            ...
            todaydes.setText(R.string.smoke);
            if(time.equals("day")){
            ...
            todaydes.setText(R.string.haze_clear);
            ...
            todaydes.setText(R.string.dust_sand);
            if(time.equals("day")){
            ...
            todaydes.setText(R.string.squall);
            if(time.equals("day")){
            ...
            todaydes.setText(R.string.clouds);
